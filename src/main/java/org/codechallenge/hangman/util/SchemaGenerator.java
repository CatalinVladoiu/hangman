package org.codechallenge.hangman.util;
...
public class SchemaGenerator {
    ...
    public static void main(String[] args) throws Exception {
        final String packageName = "org.codechallenge.hangman.model";
        SchemaGenerator gen = new SchemaGenerator(packageName);
        final String directory = "D:\\Projects\\Code-Challenge\\Hangman\\src\\main\\resources\\db\\hsqldb";
